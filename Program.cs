...
{
    Console.WriteLine($"Id: {venda.Id}, Produto: {venda.Produto}, Preço: {venda.Preco}, Data de venda: {venda.DataVenda.ToString("dd/MM/yyyy HH:mm")}");
}
...
// Venda v2 = new Venda(2, "Material de farmácia", 105.00M, dataAtual);
